...
import { shouldWarn, render } from './helpers';
...
describe('Modal', function () {
  ...
  describe('deprecations', function(){
    it('Should render the modal header and title', function() {
      let instance = render(
        <Modal show title='hello' onHide={()=>{}}>
          <strong>Message</strong>
        </Modal>
      , mountPoint);

      (()=> {
        ReactTestUtils.findRenderedDOMComponentWithTag(instance.refs.modal, 'button');
        ReactTestUtils.findRenderedComponentWithType(instance.refs.modal, Modal.Header);
        ReactTestUtils.findRenderedComponentWithType(instance.refs.modal, Modal.Title);
      }).should.not.throw();
